 ...
 */
export default function getReferenceOffsets(state, popper, reference, fixedParent = null, ignoreParentScroll = false) {
  const commonOffsetParent = fixedParent || findCommonOffsetParent(popper, reference);
  return getOffsetRectRelativeToArbitraryNode(reference, commonOffsetParent, ignoreParentScroll);
}
