...
const rollup = `${__dirname}/node_modules/.bin/rollup -c ${__dirname}/rollup.config.js`;
const minify = `node ${__dirname}/minify.js`;
const gzipped = `${__dirname}/node_modules/.bin/gzipped`;
