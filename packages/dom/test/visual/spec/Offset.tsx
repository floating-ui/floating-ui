import type {OffsetOptions, Placement, Derivable} from '@floating-ui/core';
...
const VALUES: Array<{
  ...
  {offset: 10, name: '10'},
  {offset: -10, name: '-10'},
  {offset: {align: 10}, name: 'cA: 10'},
  {offset: {side: 5, align: -10}, name: 'mA: 5, cA: -10'},
  {offset: ({rects}) => -rects.floating.height, name: '() => -f.height'},
  {
    offset: ({rects}) => ({align: -rects.floating.width / 2}),
    name: '() => cA: -f.width/2',
  },
  {offset: {align: 5}, name: 'aA: 5'},
  {offset: {align: -10}, name: 'aA: -10'},
];
