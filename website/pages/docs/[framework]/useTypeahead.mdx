...
```js
import {useTypeahead} from '@floating-ui/solid';
```
...
<Notice>
This example is only for static list items.
If you require items to be added/removed dynamically see [`FloatingList`](/docs/solid/FloatingList) .
</Notice>
</ShowFor>
