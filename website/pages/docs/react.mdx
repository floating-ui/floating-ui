...
Visit the full [`useFloating` API docs](/docs/react/useFloating)
for detailed information about customizing the positioning of
floating elements.

- [Externally pass elements](/docs/react/useFloating#elements)
- [Options](/docs/react/useFloating#options)
- [Return value](/docs/react/useFloating#return-value)
