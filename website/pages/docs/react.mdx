...
<div className="hidden flex justify-center md:justify-between items-center flex-wrap gap-2 mx-auto">
  <img
...
[View interactions examples](/docs/interactions-examples), or
read below to understand the basics.
