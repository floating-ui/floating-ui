...
```bash
npm install @floating-ui/vue@latest
```

For projects using Vue 2 or Vue 3 versions earlier than 3.3.0,
please install the previous release of this library,
as the current version requires Vue 3.3.0 or higher.

```bash
npm install @floating-ui/vue@1
```
