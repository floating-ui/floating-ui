...
version support. To upgrade these transitive packages, install
them directly, which will update your lockfile, then uninstall
them again so they aren't in your `package.json#dependencies`.
