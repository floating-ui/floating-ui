...
```js
import {useHover} from '@floating-ui/solid';
```
...
<ShowFor packages={['react-dom','react']}>
...
```js
import {useHover, safePolygon} from '@floating-ui/solid';
...
<ShowFor packages={['react']}>
  ...
  <div className="scroll">
    <div>
      Content inside here will remain blocked without affecting
