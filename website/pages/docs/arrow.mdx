...
If you're using React, the [`FloatingArrow`](/docs/FloatingArrow)
component renders out a customizable arrow element and applies
the positioning styles for you.
