...
```js
import {arrow} from '@floating-ui/solid';
```
...
<Notice>
  The [`FloatingArrow`](/docs/react/FloatingArrow) component
  renders out a customizable arrow element and applies the
  positioning styles for you.
</Notice>
...
<Notice>
  The [`FloatingArrow`](/docs/solid/FloatingArrow) component
  renders out a customizable arrow element and applies the
  positioning styles for you.
</Notice>
