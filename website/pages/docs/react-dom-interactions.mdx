...
<div className="flex justify-center md:justify-between items-center flex-wrap gap-2 mx-auto">
  <img
    className="relative sm:left-[5rem] top-[1rem] md:top-0 md:left-0 inline-block w-[335px] card"
    src="/all-inputs.png"
    alt="Designed for all inputs"
  />
  <img
    className="relative sm:left-[-5rem] top-[-1rem] md:left-0 md:top-0 inline-block w-[335px] card"
...
option to change that value (plus all of the positioning props as
...
> as this will nullify the benefits tree-shaking.
