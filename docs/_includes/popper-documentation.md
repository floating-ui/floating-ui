...
| options.modifiers.preventOverflow.boundariesElement | <code>Number</code> | <code>&#x27;scrollParent&#x27;</code> | Boundaries used by the modifier, can be `scrollParent`, `window`, `viewport` or any DOM element. |
