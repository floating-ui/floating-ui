...
title: Documentation
redirect_from:
  - /popper-documentation.html # this was the v1 documentation page
---
...
If you are looking for the <a
href="https://github.com/popperjs/popper.js/blob/v1.x/docs/_includes/popper-documentation.md">Popper
v1 documentation, click here</a>.
...
```bash
# With npm
npm i @popperjs/core@__VERSION_RANGE__

# With Yarn
yarn add @popperjs/core@__VERSION_RANGE__
```
...
on feat/fix updates easily. Please use a dependency management system like the
unpkg CDN or npm/Yarn.
...
<script src="https://unpkg.com/@popperjs/core@__VERSION_RANGE__"></script>
<script>
