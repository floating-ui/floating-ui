...
import Logo from '../../../images/popper-logo.svg';
...
Visit the [tutorial](/docs/v2/tutorial/) for an example of how to build your own
tooltip from scratch using Popper.
...
See [tree-shaking](/docs/v2/tree-shaking/) for more information.
