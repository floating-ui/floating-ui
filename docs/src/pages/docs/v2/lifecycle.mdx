...
[define your own custom modifier](../modifiers/#custom-modifiers) and take
advantage of the [effect](../modifiers/#effect) property.

If you want to make sure to run your logic after all the other modifiers have
ran, we suggest to assign the `afterWrite` `phase` to your custom modifier.
